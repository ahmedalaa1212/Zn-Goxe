...
(function initFarm() {
    ...
    // رصيد ZN يعرض دائماً 4 أرقام عشرية
        ...
        if (boostBtn) {
            ...
            if (lastBoost === todayStr) {
                ...
                if (!isBoosting) {
                    ...
                    const boostText = (currentDailyBoostRate >= GAME_CONFIG.maxDailyBoostRate)
    ...
    window.handleDailyClaim = async function(dayNum) {
        ...
        try {
            ...
            if (resData && resData.success) {
                ...
                showToast(resData?.error || "❌ تعذر استلام المكافأة اليومية");
            }
        } catch (e) {
