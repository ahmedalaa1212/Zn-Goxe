...
def start_command(message):
    try:
        ...
        welcome_message = (
            ...
            f"━━━━━━━━━━━━━━━━━━\n\n"
            f"🛑 <b>تحذير أمني هام جداً (منعاً للحظر):</b>\n"
            f"⚠️ <b>يُمنع منعاً باتاً فتح أو استخدام أكثر من حساب على نفس الجهاز!</b>\n"
            f"يقوم نظام الحماية بحظر جميع الحسابات المتعددة المرتبطة بجهاز واحد تلقائياً ودون إمكانية لاسترجاعها.\n\n"
...
def how_to_play_callback(call):
    try:
        ...
        help_text = (
            ...
            "🛑 <b>تحذير أمني صارم (شروط الاستخدام):</b>\n"
            "⚠️ يُمنع منعاً باتاً استخدام أكثر من حساب على نفس الجهاز أو الاعتماد على الحسابات المتعددة، سيؤدي كشف ذلك إلى الحظر النهائي الفوري لجميع الحسابات المرتبطة لمنع التلاعب وحماية سلامة النظام."
        )
